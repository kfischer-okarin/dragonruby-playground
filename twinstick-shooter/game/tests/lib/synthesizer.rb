def test_sawtooth_wave(_args, assert)
  generator = Synthesizer::SawtoothGenerator.new(sample_rate: 6, frequency: 2)
...
def test_sawtooth_wave_amplitude(_args, assert)
  generator = Synthesizer::SawtoothGenerator.new(sample_rate: 6, frequency: 2, amplitude: 2)
  samples = 6.map_with_index { generator.generate }
...
def test_square_wave(_args, assert)
  generator = Synthesizer::SquareGenerator.new(sample_rate: 4, frequency: 2)
...
def test_square_wave_amplitude(_args, assert)
  generator = Synthesizer::SquareGenerator.new(sample_rate: 4, frequency: 2, amplitude: 3)
  samples = 4.map_with_index { generator.generate }
...
def test_square_wave_phase_shift(_args, assert)
  generator = Synthesizer::SquareGenerator.new(sample_rate: 8, frequency: 2, phase_shift: Math::PI / 2)
...
def test_square_wave_pulse_width(_args, assert)
  generator = Synthesizer::SquareGenerator.new(sample_rate: 8, frequency: 2, pulse_width: 0.25)
  samples = 8.map_with_index { generator.generate }
